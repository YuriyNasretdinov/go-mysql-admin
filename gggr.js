window.GGGR = function()
{
	...
	function _renderAt(idx)
	{
		...
		{
			var max_width = 2;
			for(var k in _fields) max_width += _colWidth(k) + 17;

			code.push('<div class="gggr_head"><table cellspacing="0" cellpadding="0" class="table table-striped" style="width: ' + max_width + 'px; margin-bottom: 0px;" id="'+_id+'_head"><thead><tr height="'+REAL_ROW_HEIGHT+'">');
		...
		code.push('<table cellspacing="0" cellpadding="0" class="table table-striped"><tbody>');
